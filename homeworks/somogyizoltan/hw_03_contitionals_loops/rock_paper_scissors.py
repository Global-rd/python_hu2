...
while max_round > 0:
    while True:
        player_01_choise = input(f"Add meg az első játékos tippjét ebből a listából {input_list}:")
        if player_01_choise in input_list:
            break
        else:
...
if player_01_points > player_02_points:
    print(f"Az első játékos győzött {player_01_points} : {player_02_points} arányban!" )
else:
