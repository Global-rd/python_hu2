...
#  Request 4 programming languages, convert them to a list, add them to the dictionary.
...
#  Replace the first and last items in the favourite_meals list
user_info["favourite_meals"][0], user_info["favourite_meals"][-1] = user_info["favourite_meals"][-1], user_info["favourite_meals"][0]
print(f"First and last meals swapped: {user_info['favourite_meals']}")

#  Add a new item to the dictionary "phone_contacts"
...
# . Delete "Tim" from "phone_contacts"
