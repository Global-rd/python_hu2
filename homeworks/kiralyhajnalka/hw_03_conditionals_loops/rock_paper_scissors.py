...
for round_num in range(1, rounds + 1):
    ...
    if choice1 == choice2:
        print("Döntetlen! Újra kell játszani ezt a kört!")
        while True:
            choice1 = input("Első játékos választ (rock, paper, scissors): ").lower()
            if choice1 in choices:
                break
        ...
        if choice1 == choice2:
            print("Ismét döntetlen! Újraindul a kör.")
            continue  # Újraindítja az aktuális kört, ha ismét döntetlen
...
if player1_score > player2_score:
    ...
    print("A játék döntetlennel zárult!")
