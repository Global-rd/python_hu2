...
def test_checkout(mock_apply_discount, cart_with_items):
    ...
    assert final_price == 4.95
    mock_apply_discount.assert_called_once_with("SAVE10")

#mocking: egy konkrét objektum kreálása aminek fix visszatérési értékeket adunk (attribute, method)
#patching: egy metódus felülírása statikus visszatérési értékkel